...
MOCK_PROJECTS = [
    ProjectResponse(
        ...
        technologies=["Astro", "FastAPI", "MongoDB", "Tailwind CSS", "Docker", "Python", "TypeScript"],
    ...
    ProjectResponse(
        ...
        technologies=["Python", "FastAPI", "PostgreSQL", "Stripe", "Redis", "Docker", "Celery"],
...
async def reorder_projects(project_orders: List[dict]):
    """
